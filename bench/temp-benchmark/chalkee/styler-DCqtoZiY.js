import { h as handleProperty, a as registeredCodes, c as processText, f as filterMarkerCodes } from "./registry-D1iSaH7u.js";
...
function createStyler(codes = [], accumulatedText = "") {
  const cacheKey = JSON.stringify({ codes: codes.map((c) => ({ open: c.open, close: c.close })), accumulatedText });
...
//# sourceMappingURL=styler-DCqtoZiY.js.map
