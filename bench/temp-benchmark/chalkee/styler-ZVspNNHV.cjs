...
function createStyler(codes = [], accumulatedText = "") {
  ...
  if (accumulatedText === "" && codes.length === 0) {
    Object.defineProperties(stylerFunction, {
      red: {
        get() {
          return createStyler([registry.registeredCodes.red], "");
        },
        enumerable: true,
        configurable: true
      },
      blue: {
        get() {
          return createStyler([registry.registeredCodes.blue], "");
        },
        enumerable: true,
        configurable: true
      },
      green: {
        get() {
          return createStyler([registry.registeredCodes.green], "");
        },
        enumerable: true,
        configurable: true
      },
      bold: {
        get() {
          return createStyler([registry.registeredCodes.bold], "");
        },
        enumerable: true,
        configurable: true
      },
      underline: {
        get() {
          return createStyler([registry.registeredCodes.underline], "");
        },
        enumerable: true,
        configurable: true
      }
...
//# sourceMappingURL=styler-ZVspNNHV.cjs.map
