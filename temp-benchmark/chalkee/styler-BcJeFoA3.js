import { d as processText, f as filterMarkerCodes, h as handleProperty, a as registeredCodes } from "./registry-TWy_tVye.js";
...
class Styler {
  ...
  call(...args) {
    if (Array.isArray(args[0]) && "raw" in args[0]) {
      ...
      const pluginResult2 = processText(this.codes, text2, this.accumulatedText);
      let styledText2 = "";
      if (pluginResult2) {
        styledText2 = pluginResult2.styledText;
      } else {
        styledText2 = applyStyle(text2, filterMarkerCodes(this.codes));
      }
...
function createStyler(codes = [], accumulatedText = "") {
  ...
  const stylerFunction = function(...args) {
    if (Array.isArray(args[0]) && "raw" in args[0]) {
      ...
      const pluginResult2 = processText(codes, text2, accumulatedText);
      let styledText2 = "";
      if (pluginResult2) {
        styledText2 = pluginResult2.styledText;
      } else {
        styledText2 = applyStyle(text2, filterMarkerCodes(codes));
      }
...
//# sourceMappingURL=styler-BcJeFoA3.js.map
